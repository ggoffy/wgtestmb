 ...
 * @return bool|null
 */
function xoops_module_update_wgtestmb($module, $prev_version = null)
{
    $ret = null;
    /*
    if ($prev_version < 10) {
    ...
    */
    $ret = wgtestmb_check_db($module);

    //check upload directory
    require_once __DIR__ . '/install.php';
    $ret = xoops_module_install_wgtestmb($module);
 ...
 * @return bool
 */
function wgtestmb_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('wgtestmb_images');
    $field   = 'img_exif';
