 ...
 */
function xoops_module_pre_uninstall_wgtestmb(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_wgtestmb(\XoopsModule $module)
{
    $moduleDirName      = \basename(\dirname(__DIR__));
    $moduleDirNameUpper = \mb_strtoupper($moduleDirName);

    $helper = Wgtestmb\Helper::getInstance();
    ...
    if (is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_WGTESTMB_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
